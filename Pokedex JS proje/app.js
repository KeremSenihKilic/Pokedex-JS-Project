...
const createPokemonCard = (pokemon) => {
  ...
  <div class="img-container">
                <img src="#${pokemon.id}.png" alt="First pokemon">
            </div>
            <div class="poke-info">
                ...
                <div class="small">
                    ...
                    <small class="poke-weight"><i class="fa solid fa-weight-scale"></i> ${pokemon.weight} kg</small>
                </div>
                <div class="poke-type">
  ...
  pokedex_container.appendChild(pokemonDiv);
}

//fetchPokemons()
getPokemon(pokemon_value);